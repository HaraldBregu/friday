							...
							<TooltipTrigger
								render={
									<Button
										...
										onClick={() => void coder.openProject(coder.activeProject!.id)}
									>
										<FolderOpen />
									</Button>
								}
							...
							<TooltipTrigger
								render={
									<Button
										...
										onClick={() =>
											void navigator.clipboard.writeText(coder.activeProject!.directory)
										}
									>
										<Copy />
									</Button>
							...
							<TooltipTrigger
								render={
									<Button
										variant="ghost"
										size="icon-sm"
										aria-label="Remove workspace from Coder"
										disabled={coder.runState === 'running'}
