...
export default function MermaidEditor({
	...
	return (
		...
		<section className="flex min-h-0 flex-col border-b md:border-b-0 md:border-r" aria-label="Mermaid source">
		...
		<section className="flex min-h-0 flex-col" aria-label="Mermaid preview">
			...
			<div className="relative min-h-0 flex-1 overflow-auto p-5">
				{error ? (
					<div className="mx-auto flex max-w-lg gap-2 rounded-md border border-destructive/30 bg-destructive/10 p-3 text-xs text-destructive" role="alert">
